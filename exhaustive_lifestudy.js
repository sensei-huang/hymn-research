...
(async () => {
	...
	let books = ["genesis", "exodus", "leviticus", "numbers", "deuteronomy", "joshua", "judges", "ruth", "1-samuel", "1-kings", "1-chronicles", "2-chronicles", "ezra", "nehemiah", "esther", "job", "psalms", "proverbs", "ecclesiastes", "song-of-songs", "isaiah", "jeremiah", "lamentations", "ezekiel", "daniel", "hosea", "joel", "amos", "obadiah", "jonah", "micah", "nahum", "habakkuk", "zephaniah", "haggai", "zechariah", "malachi", "matthew", "mark", "luke", "john", "acts", "romans", "1-corinthians", "2-corinthians", "galatians", "ephesians", "philippians", "colossians", "1-thessalonians", "2-thessalonians", "1-timothy", "2-timothy", "titus", "philemon", "hebrews", "james", "1-peter", "2-peter", "1-john", "2-john", "3-john", "jude", "revelation"];
	for(let b = 0; b < books.length; b++){
		const url = 'https://bibleread.online/life-study-of-the-bible/life-study-of-'+books[b]+'/';
	
		await page.goto(url);

		const num = await page.evaluate(() => {
			return document.getElementsByClassName("table_of_contents")[0].children.length-1;
		});
		...
		for(let i = 1; i < num+1; i++){
			...
			const masterLatex = await page.evaluate(() => {
				...
				return latexArr.join("").replace(/[\u0400-\u04FF]/g, "~?").replace(/#/g, "\\#");
			});
